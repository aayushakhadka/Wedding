  ...
  return (
    <div id="home">
      <div
        ...
        className=" bg-weddingbg bg-cover bg-center min-h-screen min-w-full"
      >
        <div className="bg-black min-h-screen bg-opacity-50 flex flex-col items-center justify-center">
          <h1
